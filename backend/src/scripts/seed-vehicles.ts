...
const MODELS = [
  {
    ...
    fuel: 'flex' as const, transmissions: ['manual', 'automatic'] as const[],
  ...
  },
  {
    ...
    fuel: 'flex' as const, transmissions: ['automatic'] as const[],
    condition: 'used' as const,
  ...
  },
  {
    ...
    fuel: 'hybrid' as const, transmissions: ['automatic'] as const[],
    condition: 'used' as const,
  ...
  },
  {
    ...
    fuel: 'flex' as const, transmissions: ['automatic', 'cvt'] as const[],
    condition: 'used' as const,
  ...
  },
  {
    ...
    fuel: 'diesel' as const, transmissions: ['manual', 'automatic'] as const[],
    condition: 'used' as const,
